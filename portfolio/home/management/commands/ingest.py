...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument("-e", "--embedding_type", default=settings.EMBEDDING_TYPE, type=str, help="Embedding type to use - Options: text-embedding-3-small, text-embedding-3-large, text-embedding-ada-002")
